...
import { Loader2, BookOpen, Construction } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen pb-24 relative overflow-hidden">
      ...
      <main className="relative z-10 container mx-auto px-4 py-6">
        <div className="mb-6">
          <h1 className="text-2xl font-display font-bold mb-1">KNOWLEDGE BASE</h1>
          <p className="text-sm font-mono text-muted-foreground">
            Learn everything about looksmaxing
          </p>
        </div>
        ...
        <HUDCard className="p-12 text-center">
          ...
          <p className="text-muted-foreground">
            The comprehensive looksmaxing guide is under construction.
          </p>
        </HUDCard>
      </main>
    </div>
